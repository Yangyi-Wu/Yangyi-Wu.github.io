...
我主要从城市与经济地理的视角研究**城市空间结构与经济活动之间的关系**。具体而言，我关注产业网络、公共服务和基础设施如何影响城市公平、创新与韧性，也关心这些过程在不同尺度上的空间差异。

在方法上，我综合使用**空间计量、网络分析与多源城市大数据**，包括 POI、人群流动、遥感影像等数据，来理解城市转型中的空间过程与治理问题。

## 研究方向

- **经济地理与产业空间**：知识密集型产业区位、创新网络，以及产业集聚与空间扩散。
...
- 欢迎与计算机科学、经济学、地理学、城市规划等领域的同行开展跨学科合作。
- 如果你对相关研究方向或合作议题感兴趣，欢迎通过邮件联系。
...
- **2025 年**：与 Teng Yating、Liu Meitong 合作的论文 *How do urban amenities shape knowledge-intensive industry locations within cities? A multi-scalar study of Wuhan, China* 发表于 *Applied Geography*。
